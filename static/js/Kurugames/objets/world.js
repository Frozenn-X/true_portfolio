...
const world = {
    ...
    initialiserWorld: function () {
        ...
        const scoreStyle = {
            font: "bold 32px ZCOOL KuaiLe",
            color: "#FF0000",
        }
        this.scoreText = jeu.scene.add.text(16, 16, "Score : 0", scoreStyle);
    ...
    // first algo things for win or restart after loose
    finLevel: function () {
    ...
    // TODO : Gerer collisions -> collider = loose = restart 
